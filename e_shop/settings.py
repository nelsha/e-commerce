...
SECRET_KEY = 'django-insecure-0)g+n9#88ym#k1k*hjro5s^p2bxyv5(+uvroy11g#3=sn+2b$c'

# SECURITY WARNING: don't run with debug turned on in production!
PRODUCTION = os.getenv("PRODUCTION", False)
DEBUG = not PRODUCTION

ALLOWED_HOSTS = ["localhost", "127.0.0.1", "naila-shakira-gothlyrealm.pbp.cs.ui.ac.id", "10.0.2.2"]
